...
fc_left_new = ([fc_y_new;fc_y_new]);
fc_right_new = ([fc_y_new;fc_y_new]);
...
Q=[1, 0, 0, -cc_x_new;
    0, 1, 0, -cc_y_new;
    0, 0, 0, fc_left_new(1);
    0, 0, -1./T_new(1),(cc_left_new(2) - cc_right_new(2))/T_new(1)];
...
save Calib_Results_stereo_rectified om_new R_new T_new  fc_left_new cc_left_new kc_left_new alpha_c_left_new KK_left_new fc_right_new cc_right_new kc_right_new alpha_c_right_new KK_right_new nx_right_new ny_right_new nx_left_new ny_left_new Q
