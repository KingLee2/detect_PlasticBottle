function [omckk,Tckk,Rckk,JJ] = compute_extrinsic_refine_eros(omc_init,Tc_init,x_kk,X_kk,fc,cc,kc,alpha_c,MaxIter,thresh_cond),
...
%     fprintf(1,'ex_rf %d',iter+1);
    ...
    [x,dxdom,dxdT] = project_points2_eros(X_kk,omckk,Tckk,fc,cc,kc,alpha_c);
