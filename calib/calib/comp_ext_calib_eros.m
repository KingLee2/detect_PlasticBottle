...
for kk = 1:n_ima,
    ...
    if exist(['x_' num2str(kk)]),
        ...
        if active_images(kk),
            ...
            [omckk,Tckk] = compute_extrinsic_init_eros(x_kk,X_kk,fc,cc,kc,alpha_c);
            [omckk,Tckk,Rckk,JJ_kk] = compute_extrinsic_refine_eros(omckk,Tckk,x_kk,X_kk,fc,cc,kc,alpha_c,30,thresh_cond);
            if check_cond,
