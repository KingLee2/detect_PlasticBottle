function [omckk,Tckk,Rckk,JJ] = compute_extrinsic_refine_power(omc_init,Tc_init,x_kk,X_kk,fc,cc,kc,alpha_c,MaxIter,thresh_cond),
...
while (iter < MaxIter), %(change > 1e-16)&
    
%     fprintf(1,'ex_rf %d',iter+1);
    
    [x,dxdom,dxdT] = project_points2_power(X_kk,omckk,Tckk,fc,cc,kc,alpha_c);
